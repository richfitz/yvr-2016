...
\begin{frame}
  ...
  \bottomhanginglow{\only<1>{%
      \begin{minipage}{\textwidth}
        ...
        \item Generate a sodium symmetric key for the data
        \item Encrypt data key with your SSH public key
        \item Store encrypted key somewhere
        \end{enumerate}
      \end{minipage}}
    \includegraphics<2>[width=.85\textwidth]{diagrams/encryption-workflow}}
\end{frame}
...
\begin{frame}
  \minionhigh{In action}
  \bottomhanging{
    \includegraphics<1>[width=\textwidth]{snippets/encryptr-workflow-1}%
    \includegraphics<2>[width=\textwidth]{snippets/encryptr-workflow-2}%
    \includegraphics<3>[width=\textwidth]{snippets/encryptr-workflow-3}}
\end{frame}
